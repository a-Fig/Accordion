...
- [`triptych/`](ws/triptych/) — pressure-gated thirds: raw recent band, content-detected
  TypeScript/JavaScript/Python tree-sitter-L2 skeletons from assistant/thinking/tool-result blocks in
  the middle band (recoverable, tagged), lossy compaction-summary top band (compaction-naive's prompt
