...
| [`handoff/`](handoff/) | Simulates the hard reset — write a handoff doc, `/clear`, reseed a fresh agent. Owns a tiny tail (`tail-size` lock) and folds nearly everything into one handoff. The sibling foil to naive compaction. |
